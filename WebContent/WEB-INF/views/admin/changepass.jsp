  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- DataTables Example -->
        	<h2 class="form-title"><font face="Times New Roman" size="10" >Đổi Mật Khẩu</font></h2>
		<h6>${message}</h6>
		<form action="admin/change.htm" method="POST" id ="form"  enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="hoten"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input name="mkc" type="text" style = "display: inline-block"  placeholder="Nhập Mật Khẩu Cũ" size="30"  /> <br/>
                            </div>                   
                            <div class="form-group">
                                <label for="hoten"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input name="mkm" type="text" style = "display: inline-block"  placeholder="Nhập Mật Khẩu Mới" size="30"  /> <br/>
                            </div>   
                            <div class="form-group">
                                <a><input class="btn btn-primary" type="submit" value="Change"></a>
                            </div>
 ...
 <script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#form").validate({
			...
			messages: {
				mkc: "Vui lòng nhập mật khẩu cũ",
				mkm: "Vui lòng nhập mật khẩu mới",
			}
		});
	});
	</script>
