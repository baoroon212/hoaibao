  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- DataTables Example -->
        	<h2 class="form-title"><font face="Times New Roman" size="10" >Thêm Sản Phẩm</font></h2>
		<h6>${message}</h6>
		<form action="admin/insert.htm" method="POST" id ="form"  enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="hoten"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input name="tensp" type="text" style = "display: inline-block"  placeholder="Tên sản phẩm" size="40"  /> <br/>
                            </div>
                           	<div class="form-group">
                                <label for="hoten"><i class="zmdi zmdi-account material-icons-name"></i>Loại  : </label>
                                <input type="checkbox" name="tom" value="tom"> Tôm
  								<input type="checkbox" name="cuaghe" value="cuaghe"> Cua & Ghẹ
  								<input type="checkbox" name="ca" value="ca"> Cá
                         </div>
                            <h6>Hình ảnh</h6>
							<input type="file" name="image">                        
                            <div class="form-group">
                                <label for="diachi"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <textarea name="mota" placeholder="Mô tả ngắn" COLS="43" ROWS="5"></TEXTAREA><br/>
                            </div>
                            <div class="form-group">
                                <label for="sdt"><i class="zmdi zmdi-account material-icons-phone"></i></label>
                                <input name="giagoc" placeholder="Giá góc" size="40" />
                            </div>
                            <div class="form-group">
                                <a><input class="btn btn-primary" type="submit" value="Thêm"></a>
                            </div>
	...
	$(document).ready(function() {
		...
		$("#form").validate({
			...
			messages: {
				...
				image: "Vui lòng chọn ảnh sản phẩm",
