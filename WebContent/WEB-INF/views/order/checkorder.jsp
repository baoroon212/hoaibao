  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
		...
		<h2 class="form-title">Vui lòng nhập mã xác nhận</h2>
		<h6>${message}</h6>
		
		<form action="checkorder.htm" method="post"  >
		<div class="form-group">
             <label for="soluong"><i class="zmdi zmdi-email"></i></label>
             <input name="check" placeholder="Mã Xác Nhận" size="40" />
        </div>
        <div class="form-group form-button">
           	<a><input class="btn btn-primary" type="submit" value="Xác nhận"></a>
        </div>
		<form:form action="checkorder.htm" method="POST" modelAttribute="donhang">
                           ...
                           <div class="form-group" style="display: none">
                                ...
                                <form:input type="number" step="1" min="1" max="10" path="soluong" value="" title="SL" class="input-text qty text" size="4" pattern="[0-9]*" inputmode="numeric"/>
